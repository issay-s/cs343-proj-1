...
class CornersProblem(search.SearchProblem):
    ...
    def getSuccessors(self, state):
        ...
        """
        '''
        This was copied from ChatGPT after giving it the question prompt and 
...
def cornersHeuristic(state, problem):
    ...
    '''
    This was copied from ChatGPT after giving it the question prompt and 
    the surrounding code as well as my initial draft for the problem (which it
    mostly ignored). 
    '''
    position, visitedCorners = state
...
def foodHeuristic(state, problem):
    ...
    '''
    The initial code was generated by ChatGPT after giving it the problem 
    statement. We then had some ideas about efficiency improvements based on 
    going back to visited spaces, which we communicated to the AI. It then 
    generated the current code below for us. 
    '''
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState):
        ...
        gameState.
        """
        # Generated by ChatGPT after giving it the problem description
